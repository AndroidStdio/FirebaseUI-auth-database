...
public class AuthMethodPickerActivity extends IDPBaseActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_EMAIL_FLOW) {
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(AuthMethodPickerActivity.this, "111111",
            ...
            Toast.makeText(AuthMethodPickerActivity.this, "22222",
                    Toast.LENGTH_LONG).show();
            finish(RESULT_OK, new Intent());
            ...
            Toast.makeText(AuthMethodPickerActivity.this, "33333",
                    Toast.LENGTH_LONG).show();
            finish(resultCode, new Intent());
        } else {

            Toast.makeText(AuthMethodPickerActivity.this, "44444",
                    Toast.LENGTH_LONG).show();
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "AuthMethodPicker Page", // TODO: Define a title for the content shown.
                // TODO: If you have web page content that matches this app activity's content,
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app URL is correct.
                Uri.parse("android-app://com.firebase.ui.auth.ui.idp/http/host/path")
        );
