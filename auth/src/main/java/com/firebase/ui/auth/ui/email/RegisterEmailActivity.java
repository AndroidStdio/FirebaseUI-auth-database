                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if (task.isSuccessful()) {
                                                ...
                                                startActivity(VerificationEmailActivity.createIntent(
        ...
        if (view.getId() == R.id.button_create) {
            ...
            if (emailValid && passwordValid && nameValid) {
                ...
                registerUser(mEmailEditText.getText().toString(), mNameEditText.getText()
                        .toString(),password); // password = mPasswordEditText.getText().toString()
                mActivityHelper.showLoadingDialog("Signed up successfully! Please login.");
