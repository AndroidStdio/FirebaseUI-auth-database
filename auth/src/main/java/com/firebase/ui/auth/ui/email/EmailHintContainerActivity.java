...
public class EmailHintContainerActivity extends AppCompatBase {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Toast.makeText(EmailHintContainerActivity.this, "EmailHintContainerAct_onActRes",
                Toast.LENGTH_SHORT).show();
        if (requestCode == RC_HINT && data != null) {
            Credential credential = data.getParcelableExtra(Credential.EXTRA_KEY);
            if (credential == null) {
                Toast.makeText(EmailHintContainerActivity.this, "EmailHintContainerAct_onActRes_nullCredential",
                        Toast.LENGTH_SHORT).show();
